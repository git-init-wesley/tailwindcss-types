 ...
 * ```
 * @description You can refer to the official [tailwind documentation](https://tailwindcss.com/docs/backdrop-hue-rotate)
 ...
 * @example
 * ```ts
 * let value: BackdropHueRotate //Only tailwindcss types
 * let value: string | BackdropHueRotate //Your custom tailwindcss with only tailwindcss type
 * ```
 * @description You can refer to the official [tailwind documentation](https://tailwindcss.com/docs/backdrop-hue-rotate)
 * @description You can refer to the [typedoc](https://git-init-wesley.github.io/tailwindcss-types/docs/types/BackdropHueRotate.html)
 * @since Tailwind v3.2.7
 */
