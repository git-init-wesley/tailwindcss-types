 ...
 * ```
 * @description You can refer to the official [tailwind documentation](https://tailwindcss.com/docs/backdrop-brightness)
 ...
 * @example
 * ```ts
 * let value: BackdropBrightness //Only tailwindcss types
 * let value: string | BackdropBrightness //Your custom tailwindcss with only tailwindcss type
 * ```
 * @description You can refer to the official [tailwind documentation](https://tailwindcss.com/docs/backdrop-brightness)
 * @description You can refer to the [typedoc](https://git-init-wesley.github.io/tailwindcss-types/docs/types/BackdropBrightness.html)
 * @since Tailwind v3.2.7
 */
